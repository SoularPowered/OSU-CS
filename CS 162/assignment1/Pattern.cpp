...
** Patterns files:
** Find additional patterns at: http://www.argentum.freeserve.co.uk/lex.htm
** Should be able to save the pattern in a plaintext file and load it
** TODO: 	Implement such a sytem (The methods exist but not tested)
********************************************************************/
#include "Pattern.hpp"
