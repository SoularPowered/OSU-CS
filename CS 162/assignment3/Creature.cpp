...
void Creature::update_strength(int damage)
{
	...
	std::cout << this->type_name << " takes " << damage << " damage. New Strength: " << this->strength << "\n";
}
...
{
	std::cout << this->type_name << " has " << this->armor << " armor.\n";
	return this->armor;
}
...
void Creature::print_stats()
{
	...
	//std::cout << "Special Active: \t" << this->special_active << "\n";
